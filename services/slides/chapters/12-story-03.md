...
- Time-Box 60 min. Dashboard `http://localhost` zeigt den Story-3-Modus inkl. Spickzettel.
- Vollst&auml;ndige Aufgabenbeschreibung: `docs/stories/story-03-service-discovery.md`.
