...
- **Choreography statt Orchestration** &mdash; Wissen verteilt &uuml;ber Events (Br&uuml;cke zu Story 7).
...
- Br&uuml;cke zu Story 7 (Choreography): Forward bleibt &auml;hnlich, Kompensation l&auml;uft asynchron &uuml;ber Events. Booking ist nach &bdquo;Event raus&ldquo; trotzdem nicht fertig &mdash; es braucht Reply-Events plus Timeout-Erkennung. Eventing eliminiert keine Komplexit&auml;t, es verschiebt sie.
