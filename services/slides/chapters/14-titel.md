<!-- .slide: class="hero" data-background-image="./assets/circuitbreaker.png" data-background-size="45% auto" data-background-position="right 6% center" data-background-repeat="no-repeat" -->
