<!-- .slide: class="hero" data-background-image="./assets/saga.png" data-background-size="45% auto" data-background-position="right 6% center" data-background-repeat="no-repeat" -->
...
Note:
- Hook: &bdquo;Stories 4 und 5 helfen <em>einem</em> Aufruf. Aber sobald ich mehrere Schritte habe (Flug + Hotel + Auto) und einer kippt mitten drin, brauche ich was anderes. Das Hotel sagt nein, der Flug ist schon gebucht &mdash; was nun?&ldquo;
