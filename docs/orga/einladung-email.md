...
Die genaue Anleitung mit Akzeptanzkriterien steht im öffentlichen Workshop-Repo:
<https://github.com/larmic/workshop_microservices>, dort `docs/vorbereitung.md`, Abschnitt "0. Vor dem Workshop (Pflicht)".

Falls etwas hakt: Erste Hilfe gibt `docs/troubleshooting.md` (besonders für Windows/WSL2). Wenn das nicht reicht, meldet euch einfach vorab bei mir: {{KONTAKT}}. Bitte nicht erst am Workshop-Tag, da bleibt für Setup-Probleme wenig Zeit.
