# Workshop Microservices – Car Service
...
Go-basierter REST-Microservice, der Mietwagen anbietet (Liste / Buchung). Wird vom Booking-Service als Downstream-Dependency aufgerufen.
